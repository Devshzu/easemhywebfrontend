...
const ProductShowcase = () => {
  ...
  return (
    <section className="container mx-auto px-4 py-20" id="products">
      ...
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {products.map((product) => (
          <div
            key={product.id}
            className="group bg-gradient-to-b from-gray-900 to-gray-800 rounded-3xl p-8 hover:from-gray-800 hover:to-gray-700 transition-all duration-500 transform hover:scale-105 cursor-pointer border border-gray-700 hover:border-gray-600 shadow-2xl hover:shadow-purple-500/20"
          >
            <div className="relative mb-6">
              ...
              <div className={`absolute -top-2 -right-2 w-12 h-12 bg-gradient-to-r ${product.gradient} rounded-full flex items-center justify-center shadow-lg`}>
                <product.icon className="w-6 h-6 text-white" />
              </div>
            </div>
            
            <h4 className="text-2xl font-bold mb-2 text-white">{product.name}</h4>
            ...
            <button className="w-full bg-gradient-to-r from-purple-600 to-blue-600 py-3 rounded-full font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-300 group-hover:shadow-lg flex items-center justify-center">
              Learn More
